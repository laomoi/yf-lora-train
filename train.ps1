...
$pretrained_model = "d:\stable-diffusion-webui\models\Stable-diffusion\anything-v4-pruned.safetensors" # base model path | 底模路径
$train_data_dir = "D:\train\train\xuantu" # train dataset path | 训练数据集路径
...
# run train
accelerate launch --num_cpu_threads_per_process=8 "./train_network_yf.py" `
  --enable_bucket `
